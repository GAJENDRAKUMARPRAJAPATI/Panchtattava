...
const BookAppointment = () => {
  return (
    <div className="book-apm">
      <div className="book-appointment">
        <div className="book-appointment-left-content">
          <div className="book-appointment-left-content-img">
            <img
          ...
          <div className="book-appointment-contact">
            <div>
              <i className="fa-solid fa-phone"></i> +91888773373
            </div>
            <div>
              <i class="fa-regular fa-envelope"></i> info@panchatattva.com
            </div>
            <div>
              <i class="fa-solid fa-location-crosshairs"></i>Panchatattva,
              C-175, sector 100 Noida Uttar Pradesh
            </div>
          </div>
        </div>
            ...
            <div className="form-content-grid">
              ...
              <div className="mb-4">
                <select name="" style={{ width: "122px" }}>
                  ...
                  <option value=" 08:30AM -  01/09/2023">
                    {"  08:30AM - 01/09/2023"}
                  </option>
                  <option value=" 08:30PM -  01/09/2023">
                    {"  08:30PM - 01/09/2023"}
                  </option>
                </select>
              </div>
              <div className="form-radio">
                <div className="form-text">
                  <h6>In Person</h6> <input type="radio" />
                </div>
                <div className="form-text">
                  <h6> Virtual </h6>
                  <input type="radio" />
